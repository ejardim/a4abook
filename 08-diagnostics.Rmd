...
For demonstration purposes we'll use the plaice in ICES area 4 stock with a plus group at age 9, a single index "BTS-Combined (all)", and, in some cases, will trim the time series to the most recent 10 years.
