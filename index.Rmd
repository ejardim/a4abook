...
author:
  - name: "Ernesto Jardim"
    affiliation: "Instituto Portugues do Mar e Atmosfera (IPMA), Lisbon"
  - name: "Collin Millar"
    affiliation: "International Council for the Exploration of the Sea (ICES), Copenhaguen"
  - name: "Danai Mantopoulou Palouka"
    affiliation: "European Commission Joint Research Centre (JRC), Brussels"
  - name: "Iago Mosqueira"
    affiliation: "Wageningen Marine Research (WMR), Ijmauden"
date: "`r Sys.Date()`"
