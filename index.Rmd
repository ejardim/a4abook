...
author:
  - name: "Ernesto Jardim"
    affiliation:
      - "Instituto Portugues do Mar e Atmosfera (IPMA), Lisbon, Portugal"
...
To run the methods in this book the reader will need to install the `FLa4a` package [@fla4a], `FLCore` [], some FLR packages, and relevant dependencies. Some datasets are distributed with the package and as such need to be loaded too.
