...
Diagnostic tools should be used together to evaluate proper mixing and convergence.
...
```{r, acf01, fig.cap="Autocorrelation plot of the first parameter in the MCMC chain. High correlation chain in blue, low correlation chain in red."}
acfplot(mcmc.list(mc01=fitmc01.mc[,1], mc02=fitmc02.mc[,1]), type="p", pch=19, col=c(2,4))
```
