...
For this section we'll be using the package `FLasher` [\flasher] from the FLR family of packages.
...
$if \quad SSB_y > 0.5xB_{MSY} \quad then \quad F_{y+1} = F_{MSY} \quad or \quad else \quad F_{y+1} = 0.8xF_{MSY}$
