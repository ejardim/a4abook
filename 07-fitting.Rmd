...
```{r, plt02, fig.cap="Stock summary - close to official assessment"}
plot(stk0)
```
...
```{r, vm, echo=FALSE, fig.cap="Catch at age variance model with a year effect."}
